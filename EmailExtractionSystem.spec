...
a = Analysis(
    ['D:\\Startups\\ITVE\\email-extraction-system\\run_desktop.py'],
    pathex=['D:\\Startups\\ITVE\\email-extraction-system\\backend'],
    binaries=[],
    datas=[('D:\\Startups\\ITVE\\email-extraction-system\\frontend', 'frontend')],
